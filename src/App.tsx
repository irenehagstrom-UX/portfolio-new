  ...
  const disciplineProjects = [
    ...
    },
    {
      ...
      modalContent: {
        ...
        outcomes:
          "TESTING As in any field it's an ongoing learning journey. I am looking at understaning overall application development and deployment, system prompting, UI design for AI tools and more. This portfolio is an ever evolving product using tools such as TempoLabs, Leonardo.ai, and ChatGPT and GitHub.",
